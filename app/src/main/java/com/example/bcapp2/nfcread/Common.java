...
import static com.example.bcapp2.nfcread.Preferences.Preference.AutoCopyUID;
import static com.example.bcapp2.nfcread.Preferences.Preference.UIDFormat;
...
public class Common extends Application {
     ...
     */
    public static final String HOME_DIR = "/BCApp2";
...
// ############################################################################
    ...
    public static File getFile(String relativePath) {
        Log.d(LOG_TAG, "dir -->" + mAppContext.getFilesDir());
        ...
        try {
            while ((line = reader.readLine()) != null) {
                ...
                try {
                    ...
                    Toast.makeText(context, "tooo big file",
    ...
    public static void checkFileExistenceAndSave(final File file,
        ...
        if (file.exists()) {
            ...
            new AlertDialog.Builder(context)
                    ...
                    .setPositiveButton("replace",
                            (dialog, which) -> {
                                ...
                                if (Common.saveFile(file, lines, false)) {
                                    Toast.makeText(context, "save ok",
                                            Toast.LENGTH_LONG).show();
                    ...
                    .setNeutralButton("append?",
                            (dialog, which) -> {
                                // Append.
                                if (Common.saveFileAppend(file, lines, isDump)) {
                                    Toast.makeText(context, "save ok2",
                                            Toast.LENGTH_LONG).show();
                                    activity.onSaveSuccessful();
                                } else {
                                    Toast.makeText(context, "save error2",
                                            Toast.LENGTH_LONG).show();
                                    activity.onSaveFailure();
                                }
                            })
            ...
            if (Common.saveFile(file, lines, false)) {
                Toast.makeText(context, "save ok3",
                        Toast.LENGTH_LONG).show();
                activity.onSaveSuccessful();
            } else {
                Toast.makeText(context, "save error3",
                        Toast.LENGTH_LONG).show();
                activity.onSaveFailure();
            }
        }
    ...
    public static int treatAsNewTag(Intent intent, Context context) {
        ...
        if (NfcAdapter.ACTION_TECH_DISCOVERED.equals(intent.getAction())) {
            ...
            if (isCopyUID) {
                ...
                Toast.makeText(context, "UID " + "Copy!".toLowerCase() + " (" + fmtUID + ")", Toast.LENGTH_SHORT).show();
                copyToClipboard(fmtUID, context, false);
            } else {
                // Show Toast message with UID.
                String id = "This is tag!  " + " (UID: ";
    ...
    public static MCReader checkForTagAndCreateReader(Context context) {
        ...
        if (mTag != null && (reader = MCReader.get(mTag)) != null) {
            ...
            if (!tagLost) {
                Log.d(LOG_TAG, "return reader = MCReader.get(mTag) -->" + reader);
                return reader;
            }
        }
    ...
    public static void isValidDumpErrorToast(int errorCode,
        ...
        switch (errorCode) {
            case 1:
                Toast.makeText(context, "no dump7",
                        Toast.LENGTH_LONG).show();
                break;
            case 2:
                Toast.makeText(context, "no dump5",
                        Toast.LENGTH_LONG).show();
                break;
            case 3:
                Toast.makeText(context, "no dump4",
                        Toast.LENGTH_LONG).show();
                break;
            case 4:
                Toast.makeText(context, "no dump3",
                        Toast.LENGTH_LONG).show();
                break;
            case 5:
                Toast.makeText(context, "no dump2",
                        Toast.LENGTH_LONG).show();
                break;
            case 6:
                Toast.makeText(context, "no dump",
                        Toast.LENGTH_LONG).show();
                break;
        }
    }
    ...
    public static boolean isValidKeyFileErrorToast(
        ...
        switch (errorCode) {
            ...
            case 2:
                ...
                break;
            case 3:
                Toast.makeText(context, "no 6 byte",
                        Toast.LENGTH_LONG).show();
                break;
        }
        return false;
    ...
    public static void shareTextFile(Context context, File file) {
        ...
        try {
            ...
            Toast.makeText(context, "share txt error",
                    Toast.LENGTH_SHORT).show();
            return;
        }
     ...
     * The {@link .KeyMapCreator} will do
